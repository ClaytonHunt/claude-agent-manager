...
export interface WebSocketMessage {
  type: 'agent_update' | 'log_entry' | 'handoff' | 'ping' | 'pong' | 'tool_started' | 'tool_completed' | 'agent_started' | 'agent_stopped' | 'agent_notification' | 'agent_created' | 'agent_deleted' | 'agent_error';
  data: any;
  timestamp: Date;
}
