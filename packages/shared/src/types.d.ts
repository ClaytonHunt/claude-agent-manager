...
export interface WebSocketMessage {
    type: 'agent_update' | 'log_entry' | 'handoff' | 'ping' | 'pong';
    data: any;
    timestamp: Date;
}
...
export declare class ValidationError extends AgentManagerError {
    constructor(message: string);
}
export declare class NotFoundError extends AgentManagerError {
    constructor(message: string);
}
